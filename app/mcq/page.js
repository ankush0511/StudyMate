...
export default function MCQGeneratorContent() {
    ...
    const getOptionStyle = (mcq, questionIndex, optionKey) => {
        ...
        if (showResults) {
            if (isCorrect) {
                return 'bg-green-100 text-green-900 ring-2 ring-green-500 shadow-lg shadow-green-500/50';
            }
            if (isSelected && !isCorrect) {
                return 'bg-red-100 text-red-900 ring-2 ring-red-500 shadow-lg shadow-red-500/50';
            }
            return 'bg-gray-100 border-gray-200 text-gray-600 opacity-80';
        }

        if (isSelected) {
            return 'bg-blue-500 border-blue-600 text-white shadow-md ring-2 ring-blue-500';
        }
